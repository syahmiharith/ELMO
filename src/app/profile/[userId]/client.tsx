...
import { User, Users, Calendar, MapPin, Building, Mail, Shield, Check, BadgeCheck } from 'lucide-react';
...
export default function ProfilePageClient({ userId }: { userId: string }) {
  ...
  const isPPMK = isOwnProfile && role === 'PPMK';
          ...
          <div className="flex flex-col items-center md:items-start">
              ...
              <div className="mt-4 text-center md:text-left">
                  <h1 className="text-2xl font-bold flex items-center gap-2">
                    {profileUser.name}
                    {isPPMK && <BadgeCheck className="size-6 text-blue-500" />}
                  </h1>

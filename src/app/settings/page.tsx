...
import { User, Edit, Loader2, Sparkles, Users, Calendar, Palette, Accessibility, Shield } from 'lucide-react';
    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage your account, app preferences and accessibility settings.
        </p>
      </div>
      ...
      <Tabs defaultValue="account" className="w-full">
        <TabsList className="grid w-full grid-cols-5">
          ...
          <TabsTrigger value="account"><Shield className="mr-2"/>Account</TabsTrigger>
          <TabsTrigger value="personalization"><Sparkles className="mr-2"/>Personalization</TabsTrigger>
          <TabsTrigger value="appearance"><Palette className="mr-2"/>Appearance</TabsTrigger>
          <TabsTrigger value="accessibility"><Accessibility className="mr-2"/>Accessibility</TabsTrigger>
        </TabsList>
                ...
                <CardContent className="space-y-8">
                    ...
                    {/* Connected Accounts */}
                     <Card>
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground mb-4">Link your university account to other services for easier sign-in.</p>

...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn("hidden h-full md:flex flex-col group peer text-sidebar-foreground transition-all duration-200",
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <Icon className="group-data-[state=collapsed]:hidden" />
      <PanelRight className="group-data-[state=expanded]:hidden" />

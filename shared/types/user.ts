...
export interface UserBase {
    ...
    interests?: string[];
    consents?: Record<string, boolean | number>; // Support both boolean and timestamp values
...
export interface User extends UserBase {
    ...
    photoUrl?: string; // Legacy field name for photoURL
    savedClubs?: string[];
    memberships?: any[]; // Including memberships from old interface
    roleHint?: Role;
